...
\begin{align}
    ...
    & = \sum_{i=1}^n (Y_i - \hat Y_i)^2 + 
        ...
        \sum_{i=1}^n  (\hat Y_i - \bar Y)^2 \label{eq:r2-expand} \\
\end{align}
$$
...
#### Joe | Wed 04 Nov, 2015
Thus, middle term in $\ref{eq:r2-expand}$ is zero, and so total variability equals sum of regression variability and error variability terms.
